...
import { CreditCard, Calendar, DollarSign, Download, Filter, CheckCircle, Clock, XCircle, RefreshCw, TrendingUp, Users, Car } from "lucide-react";
...
const ProviderPayments = () => {
  ...
  const fetchPayments = useCallback(async () => {
    ...
    try {
      ...
      const payments = await paymentAPI.getTransportPayments();
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50 to-green-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6">
          <Breadcrumb 
            items={[
              { label: 'Dashboard', path: '/transport', isHome: true },
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-slate-600">Track and manage your transport payment transactions</p>
        </div>
