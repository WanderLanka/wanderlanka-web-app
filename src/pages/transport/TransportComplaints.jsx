      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
          <div>
            ...
            <p className="text-slate-600">Track and manage complaints related to your transport services</p>
          </div>
          <Link to="/transport/complaints/submit">
          ...
          <div className="flex flex-wrap gap-4">
            <div className="flex items-center space-x-2">
              ...
              <select
                ...
                className="px-3 py-2 border border-slate-300 rounded-lg text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500"
              >
              ...
              <div key={complaint._id} className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-md transition-shadow">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-4 text-xs text-slate-500">
                      ...
                      {complaint.complaintId && (
                        <div className="flex items-center space-x-1">
                          <span className="font-mono text-emerald-600">#{complaint.complaintId}</span>
                        </div>
                      )}
                    </div>
                  </div>
                  <Link to={`/transport/complaints/${complaint._id}`}>
                ...
                {complaint.adminResponse && (
                  <div className="mt-4 p-4 bg-emerald-50 border border-emerald-200 rounded-lg">
                    <p className="text-sm font-semibold text-emerald-900 mb-1">Admin Response</p>
                    <p className="text-sm text-emerald-800">{complaint.adminResponse.message}</p>
